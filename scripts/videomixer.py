...
# POST /inputs/add params : {channel: n, url: 'rtsp:///wowza.com:1935/app/stream.sdp'} [experimental] 
# POST /inputs/add params : {channel: n, url: 'rtmp:///wowza.com:1935/app/stream.sdp'} [experimental] 
# POST /inputs/add params : {channel: n, url: 'http:///server.com:8000/videostream.mpg'} [experimental] 
